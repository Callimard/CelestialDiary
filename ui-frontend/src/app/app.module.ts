...
} from './application/employee-management/employee-information/employee-form-updater/employee-form-updater.component';
import {
  EmployeeFormCreatorComponent
} from './application/employee-management/employee-creation/employee-form-creator/employee-form-creator.component';
import {
  EstablishmentFormCreatorComponent
} from './application/establishment-management/establishment-creation/establishment-form-creator/establishment-form-creator.component';
import {
  EstablishmentFormUpdaterComponent
} from './application/establishment-management/establishment-information/establishment-information-updater/establishment-form-updater.component';
import {TimeIntervalFormComponent} from './libairy/form/time-interval-form/time-interval-form.component';
import {
  ProductSelectionComponent
} from './application/product-management/product-selection/product-selection.component';
...
} from './application/product-management/product-information/product-information.component';
...
} from './application/prestation-management/prestation-selection/prestation-selection.component';
import {
  PrestationInformationComponent
} from './application/prestation-management/prestation-information/prestation-information.component';
import {
  PrestationCreationComponent
} from './application/prestation-management/prestation-creation/prestation-creation.component';
...
} from './application/bundle-management/bundle-information/bundle-information.component';
...
} from './application/product-management/product-creation/product-form-creator/product-form-creator.component';
...
} from './application/product-management/product-information/product-form-updater/product-form-updater.component';
import {
  PrestationFormCreatorComponent
} from './application/prestation-management/prestation-creation/prestation-form-creator/prestation-form-creator.component';
import {
  PrestationFormUpdaterComponent
} from './application/prestation-management/prestation-information/prestation-form-updater/prestation-form-updater.component';
import {
  BundleFormCreatorComponent
} from './application/bundle-management/bundle-creation/bundle-form-creator/bundle-form-creator.component';
import {
  BundleFormUpdaterComponent
} from './application/bundle-management/bundle-information/bundle-form-updater/bundle-form-updater.component';
import {
  EstablishmentSelectionComponent
} from './application/establishment-management/establishment-selection/establishment-selection.component';
import {
  EstablishmentCreationComponent
} from './application/establishment-management/establishment-creation/establishment-creation.component';
import {
  EstablishmentInformationComponent
} from './application/establishment-management/establishment-information/establishment-information.component';
import {
  EmployeeSelectionComponent
} from './application/employee-management/employee-selection/employee-selection.component';
import {
  EmployeeCreationComponent
} from './application/employee-management/employee-creation/employee-creation.component';
import {
  EmployeeInformationComponent
} from './application/employee-management/employee-information/employee-information.component';
...
} from './application/role-management/role-creation/role-form-creator/role-form-creator.component';
import {
  PrivilegeInputLineComponent
} from './application/role-management/utils/privilege-input-line/privilege-input-line.component';
import {
  RoleFormUpdaterComponent
} from './application/role-management/role-information/role-form-updater/role-form-updater.component';
import {
  RoleFormContentComponent
} from './application/role-management/utils/role-form-content/role-form-content.component';
...
} from './application/employee-management/utils/employee-form-content/employee-form-content.component';
import {
  EmployeeRoleSelectionComponent
} from './application/employee-management/utils/employee-role-selection/employee-role-selection.component';
import {
  EmployeeRoleUpdaterComponent
} from './application/employee-management/employee-information/employee-role-updater/employee-role-updater.component';
import {
  AdvancedBasicInputFormComponent
} from './libairy/form/advanced-basic-input-form/advanced-basic-input-form.component';
import {
  BundleFormContentComponent
} from './application/bundle-management/utils/bundle-form-content/bundle-form-content.component';
import {
  EquipmentSelectionComponent
} from './application/equipment-management/equipment-selection/equipment-selection.component';
import {
  EquipmentInformationComponent
} from './application/equipment-management/equipment-information/equipment-information.component';
import {
  EquipmentCreationComponent
} from './application/equipment-management/equipment-creation/equipment-creation.component';
import {
  EquipmentFormCreatorComponent
} from './application/equipment-management/equipment-creation/equipment-form-creator/equipment-form-creator.component';
import {
  EquipmentFormContentComponent
} from './application/equipment-management/utils/equipment-form-content/equipment-form-content.component';
import {
  EquipmentFormUpdaterComponent
} from './application/equipment-management/equipment-information/equipment-form-updater/equipment-form-updater.component';
import {
  PrestationFormContentComponent
} from './application/prestation-management/utils/prestation-form-content/prestation-form-content.component';
import {
  EmployeePrestationSelectionComponent
} from './application/employee-management/utils/employee-prestation-selection/employee-prestation-selection.component';
import {
  EmployeeEstablishmentAssignationComponent
} from './application/employee-management/employee-information/employee-establishment-assignation/employee-establishment-assignation.component';
import {
  CheckBoxDetailsSummaryComponent
} from './libairy/form/check-box-details-summary/check-box-details-summary.component';
import {
  EstablishmentFormContentComponent
} from './application/establishment-management/utils/establishment-form-content/establishment-form-content.component';
import {ClientSelectionComponent} from './application/client-management/client-selection/client-selection.component';
import {
  ClientInformationComponent
} from './application/client-management/client-information/client-information.component';
...
} from './application/client-management/client-creation/client-form-creator/client-form-creator.component';
import {
  ClientFormContentComponent
} from './application/client-management/utils/client-form-content/client-form-content.component';
import {
  ClientFormUpdaterComponent
} from './application/client-management/client-information/client-form-updater/client-form-updater.component';
import {
  EmployeeWorkingHoursUpdaterComponent
} from './application/employee-management/employee-information/employee-working-hours-updater/employee-working-hours-updater.component';
import {
  EmployeeEstablishmentWorkingHoursComponent
} from './application/employee-management/employee-information/employee-working-hours-updater/employee-establishment-working-hours/employee-establishment-working-hours.component';
