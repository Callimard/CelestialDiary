...
@PreAuthorize("hasAnyAuthority('company:' + #idCompany + ':employee:create', 'company:' + #idCompany + ':employee:all', 'company:' + #idCompany + " +
        "':employee:activate', 'company:' + #idCompany + ':all')")
public @interface CreateCompanyEmployeePrivilege {
}
