...
@PreAuthorize("hasAnyAuthority('company:' + #idCompany + ':employee:update', 'company:' + #idCompany + ':employee:all', 'company:' + #idCompany + " +
        "':employee:activate', 'company:' + #idCompany + ':all')")
public @interface UpdateCompanyEmployeePrivilege {
}
