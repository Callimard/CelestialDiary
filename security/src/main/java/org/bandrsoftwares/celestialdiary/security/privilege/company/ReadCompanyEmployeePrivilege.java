...
@PreAuthorize("hasAnyAuthority('company:' + #idCompany + ':employee:read', 'company:' + #idCompany + ':employee:all', 'company:' + #idCompany + " +
        "':employee:activate', 'company:' + #idCompany + ':all')")
public @interface ReadCompanyEmployeePrivilege {
}
