...
/**
 * An {@link EmployeeWorkingHoursDTO} without document references to avoid DB call.
 */
public record WrappedEmployeeWorkingHoursDTO(
        String id,
        int year,
        int weekNumber,
    ...
    public WrappedEmployeeWorkingHoursDTO(EmployeeWorkingHours employeeWorkingHours) {
        this(
